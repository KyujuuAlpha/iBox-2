...
class DriveEditorViewController: UITableViewController, UITextFieldDelegate {
    ...
    func textFieldDidEndEditing(_ textField: UITextField) {
        ...
        case .heads: (self.drive as! HardDiskDrive).heads = NSNumber(value: Int(textField.text!)!)
        case .cylinders: (self.drive as! HardDiskDrive).cylinders = NSNumber(value: Int(textField.text!)!)
        case .sectorsPerTrack: (self.drive as! HardDiskDrive).sectorsPerTrack = NSNumber(value: Int(textField.text!)!)
        default:
