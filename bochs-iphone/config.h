...
#define BX_USE_E1000_SMF    0  // Intel(R) Gigabit Ethernet
#define BX_USE_NE2K_SMF     1  // NE2K
#define BX_USE_EFI_SMF      0  // External FPU IRQ
#define BX_USE_GAMEPORT_SMF 0  // Gameport
